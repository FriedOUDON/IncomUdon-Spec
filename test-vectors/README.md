...
| `management/private-control-link-v1.json` | Private Control Link framing, message envelopes, fixed-deadline revocation idempotency and durability, and diagnostics lifecycle semantics |
