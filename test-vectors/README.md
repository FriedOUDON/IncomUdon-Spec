...
| `management/private-control-link-v1.json` | Private Control Link framing, message envelopes, service-admission revocation idempotency, and diagnostics lifecycle semantics |
